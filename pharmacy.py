...
plot_graph.add_new_event("Customer leaves pharmacy")
...
plot_graph.get_event("Customer takes change").is_before(plot_graph.get_event("Customer leaves pharmacy"))
...
plot_graph.get_event("Customer takes receipt").is_before(plot_graph.get_event("Customer leaves pharmacy"))
plot_graph.get_event("Customer can't produce prescription").is_before(plot_graph.get_event("Pharmacist refuses to sell"))
plot_graph.get_event("Pharmacist refuses to sell").is_before(plot_graph.get_event("Customer leaves pharmacy"))
